...
void PathGenerator::BuildPointPath(float const* startPoint, float const* endPoint, PathQueryDiagnostics* diagnostics)
{
...
bool PathGenerator::HaveTile(G3D::Vector3 const& p, PathQueryDiagnostics::Tile* diagnostics) const
{
    int tx = -1, ty = -1;
